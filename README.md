...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.19184225.svg)](https://doi.org/10.5281/zenodo.19184225)
...
```bash
pytest tests/ -v  # 172 tests, 82% coverage
```
...
Full tutorial documentation is built with Sphinx and deployed to GitHub Pages:
